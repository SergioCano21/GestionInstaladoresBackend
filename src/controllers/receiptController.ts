  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      const receiptData = {
        ...
        installedProduct: installedProduct.installedProduct,
        installedIn: installedProduct.installedIn,
        quantity: installedProduct.quantity,
        specification: installedProduct.specification,
